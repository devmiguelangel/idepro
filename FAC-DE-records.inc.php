...
if(isset($_GET['ide'])){
	...
	$sqlId = 'SELECT no_emision FROM s_de_em_cabecera WHERE id_emision = "'.$ide.'" ;';
...
?>
<h3>Registros Facultativos - Desgravamen</h3>
...
?>
		...
		<select id="fde-prefix" name="fde-prefix" style="width: auto;">
