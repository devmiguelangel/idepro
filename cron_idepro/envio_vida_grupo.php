...
//echo $conexion;
    $date=date("Y-m-d");
	//echo $date; 
$selectdes="SELECT t0.no_emision, 
                   t2.nombre, 
				   t2.paterno, 
				   t2.materno,
				   t2.ci, 
				   case t2.genero when 'F' then 'Femenino' 
				  ...
				  t0.prefijo,
				  t0.fecha_emision
FROM s_de_em_cabecera t0 inner join  s_de_em_detalle t1 on t0.id_emision = t1.id_emision 
...
inner join s_de_cot_cabecera t6 on t0.id_cotizacion = t6.id_cotizacion
...
$shtml="<table border='0' cellspacing='1' cellpadding='0' style='width:150%; font-size:9pt;'>";
			$shtml.='<tr><td colspan="11" align="center"> REPORTE DE CERTIFICADOS DESGRAVAMEN FECHA &nbsp;'.$date1.'</td></tr>';
