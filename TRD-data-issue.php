...
?>
            ...
            <label>Zona domicilio: <span>*</span></label><br>
            <textarea id="dc-zone-home" name="dc-zone-home" class="<?=$read_nat;?> fbin" <?=$read_new.' '.$read_save;?>><?=$row['cl_zona'];?></textarea><br>
...
?>
            ...
            <label>Zona domicilio: <span>*</span></label><br>
			<textarea id="dc-company-zone-home" name="dc-company-zone-home" class="<?=$read_jur;?> fbin" <?=$read_new.' '.$read_save;?>><?=$row['cl_zona'];?></textarea><br>
...
?>
        <tr class="title-vh" valign="top">
			<td style="width:30%;">Departamento</td>
			<td style="width:20%;">Zona</td>
...
?>
            ...
            <td>
            	<input type="text" id="dp-<?=$k;?>-locality" name="dp-<?=$k;?>-locality" 
            		...
            		class="required text-2 fbin " <?=$read_new . ' ' . $read_save;?>>
            </td>
            <td colspan="2">
        ...
        <tr class="title-vh" valign="top">
			...
			<td >Uso</td>
			<td >Estado</td>
            <td style="width: 15%;">Valor Comercial</td>
            <td style="width: 15%;">Prima</td>
        </tr>
        <tr valign="top" class="thead">
        	<td>
        		<textarea id="dp-<?=$k;?>-type" name="dp-<?=$k;?>-type" 
            		class="required fbin" <?=$read_new . ' ' 
            		. $read_save;?>><?=$rowPr['pr_tipo'];?></textarea>
        	</td>
        	<td>
            	<select id="dp-<?=$k;?>-use" name="dp-<?=$k;?>-use" 
            		class="required fbin <?=$read_new;?> dp-use" 
            		<?=$read_save;?> data-rel="<?=$k;?>">
            		<option value="">Seleccione...</option>
<?php
...
?>
            ...
            <td>
            	<select id="dp-<?=$k;?>-state" name="dp-<?=$k;?>-state" 
