							...
							<table class="da-table">
								<thead>
									<tr>
									  ...
									  <th><b>Tasa</b></th>
									  <th><b>Tasa Categoria A</b></th>
									  <th><b>Tasa Categoria B</b></th>
...
<div class="da-panel collapsible" style="width:600px;">
	<div class="da-panel-header">
		<span class="da-panel-title">
			<img src="images/icons/black/16/list.png" alt="" />
		    <b>'.$entidad.'</b>
			<div style="margin-left:25px;"><b>'.$compania.'</b> - Agregar nueva tasa</div>
		</span>
	</div>
	<div class="da-panel-content">';
					...
					<table class="da-table">
						...
						echo'<tr>
								...
								<td>
								 ...
								 <span class="errorMessage" id="errortasaincrac"></span>
								...
								<td>
								 ...
								 <span class="errorMessage" id="errortasaincoth"></span>
