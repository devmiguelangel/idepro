			  ...
			  <div class="da-panel-header" style="text-align:right; padding-top:5px; padding-bottom:5px;">
				  <ul class="action_user">
					  <li style="margin-right:6px;">
						 <a href="adicionar_registro.php?opcion=crear_agencia&id_ef_sesion='.base64_encode($id_ef_sesion).'&tipo_sesion='.base64_encode($tipo_sesion).'" class="da-tooltip-s various fancybox.ajax" title="Añadir nueva agencia">
		...
		echo'<div class="da-panel collapsible" style="width:750px;">
				<div class="da-panel-header">
					<span class="da-panel-title">
						...
						<b>'.$regief['nombre'].'</b> - listado de agencias
					</span>
				</div>
				<div class="da-panel-content">
					<table class="da-table">
						<thead>
							<tr>
								<th><b>Agencia</b></th>
								<th style="text-align:center;"><b>Departamento<br/>/Sucursal</b></th>
								<th style="text-align:center;"><b>Codigo</b></th>
								<th style="text-align:center;"><b>Emision</b></th>
								<th></th>
							</tr>
						</thead>
						<tbody>';
...
<div class="da-panel collapsible">
    <div class="da-panel-header" style="text-align:right; padding-top:5px; padding-bottom:5px;">
		<ul class="action_user">
			<li style="margin-right:6px;">
			   <a href="adicionar_registro.php?opcion=crear_sucursal&tipo_sesion='.base64_encode($tipo_sesion).'&id_ef_sesion='.base64_encode($id_ef_sesion).'" class="da-tooltip-s cuestionario fancybox.ajax" title="Añadir Nuevo Registro">
			   <img src="images/add_new.png" width="32" height="32"></a>
			</li>
		</ul>
	</div>
...
<div class="da-panel collapsible" style="width:850px;">
	<div class="da-panel-header">
		<span class="da-panel-title">
			<img src="images/icons/black/16/list.png" alt="" />
			Listado Departamentos/Sucursales
		</span>
	</div>
	<div class="da-panel-content">
		<table class="da-table">
			<thead>
				<tr>
					...
					<th><b>Codigo</b></th>
					<th style="text-align:center;"><b>Tipo CI</b></th>
					<th style="text-align:center;"><b>Tipo Regional</b></th>
					<th style="text-align:center;"><b>Tipo Departamento</b></th>
					<th style="text-align:center;"><b>Entidad Financiera</b></th>
								...
								<td class="da-icon-column">
								   <ul class="action_user">';
									  echo'<li style="margin-right:5px;">';
									        if($tipo_sesion=='ROOT'){
									            echo'<a href="adicionar_registro.php?opcion=editar_sucursal&id_depto='.base64_encode($regi['id_depto']).'&tipo_sesion='.base64_encode($tipo_sesion).'&id_ef_sesion='.base64_encode($id_ef_sesion).'" class="edit da-tooltip-s cuestionario fancybox.ajax" title="Editar"></a>';
