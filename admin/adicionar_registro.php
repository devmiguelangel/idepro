...
$(document).ready(function(e) {
			 ...
			 $(this).find('.required').each(function(){
				 ...
				 if(sucursal!=''){
					 if(sucursal.match(/^[0-9a-zA-ZáéíóúàèìòùÀÈÌÒÙÁÉÍÓÚñÑüÜ\s]+$/)){
						 $('#errorsucursal').hide('slow');
					 }else{
					    sum++;
						$('#errorsucursal').show('slow');
					 ...
					 $.ajax({
						   ...
						   success: function(datareturn) {
								  ...
								  if(datareturn==1){
									...
									$('#errorcompania').show('slow');
					                $('#errorcompania').html('esta compañia ya esta añadida seleccione otra compañia');
								  }
						   }
					 });
					 e.preventDefault();
			 ...
			 $(this).find('.required').each(function() {
                  if(productos!=''){
					  if(productos.match(/^[a-zA-Z\s]+$/)){
						  $('#errorproductos').hide('slow');
					  }else{
						  sum++;
					      $('#errorproductos').show('slow');
		...
		$('#frmAdPregunta').submit(function(e){
			...
			if(sum==0){
				   ...
				   e.preventDefault();
				   var dataString = 'pregunta='+pregunta+'&id_ef_cia='+id_ef_cia+'&respuesta='+respuesta+'&opcion=crea_pregunta';
				   //alert (dataString);
				   //ejecutando ajax
				   $.ajax({
						 async: true,
		...
		$('#frmEdiPregunta').submit(function(e){
			...
			if(sum==0){
				   ...
				   e.preventDefault();
				   var dataString = 'pregunta='+pregunta+'&id_ef_cia='+id_ef_cia+'&id_pregunta='+id_pregunta+'&respuesta='+respuesta+'&opcion=edita_pregunta';
				   //alert (dataString);
				   //ejecutando ajax
				   $.ajax({
						 async: true,
		...
		$('#frmAdProdExtra').submit(function(e){
			...
			if(sum==0){
				   ...
				   $.ajax({
						 ...
						 type: "POST",
						 url: "accion_registro.php",
						 data: FormCadena+'&opcion=crea_prodextra',
						 beforeSend: function(){
							  $("#response-loading").css({
								  'height': '30px'
							  });
		...
		$('#frmEdiProdExtra').submit(function(e){
			...
			if(sum==0){
				   ...
				   e.preventDefault();
				   var FormCadena = $(this).serialize();
				   //var dataString = 'hospitalario='+hospitalario+'&vida='+vida+'&cesantia='+censatia+'&prima='+prima+'&id_ef_cia='+id_ef_cia+'&id_pr_extra='+id_pr_extra+'&opcion=edita_prodextra';
				   //alert (dataString);
				   //ejecutando ajax
				   $.ajax({
						 async: true,
						 ...
						 type: "POST",
						 url: "accion_registro.php",
						 data: FormCadena+'&opcion=edita_prodextra',
						 beforeSend: function(){
							  $("#response-loading").css({
								  'height': '30px'
							  });
		...
		$('#txtRgMinBs').blur(function(e){
			...
			var valor_bs = $('#valor_boliviano').prop('value');
			...
			if (minimo_bs == "") {
			   ...
			   $('#errorminbs').focus();
				...
				$('#errorminbs').hide('slow');
				var equiv = parseInt(minimo_bs/valor_bs);
		...
		$('#txtRgMaxBs').blur(function(e){
			...
			if (maximo_bs == "") {
			   ...
			   $('#errormaxbs').focus();
				...
				$('#errormaxbs').hide('slow');
				var equiv = parseInt(maximo_bs/valor_bs);
		...
		$('#frmAdTipoTarjeta').submit(function(e){
			...
			$(this).find('.required').each(function() {
                 if(tipotarjeta!=''){
					 $('#errortipotarjeta').hide('slow');
				 }else{
				     sum++;
				     $('#errortipotarjeta').show('slow');
				   ...
				   $.ajax({
						 ...
						 success: function(datareturn) {
						        ...
						        if(datareturn==0){
								   ...
								   $('#response-loading').html('<div style="color:#d44d24;">el tipo de tarjeta ya existe, seleccione otro</div>');
								   e.preventDefault();
	 ...
	 echo'<div class="da-panel">
			  ...
			  <div class="da-panel-content">
				  <form class="da-form" action="" method="POST" name="formCreaCorreo" id="formCreaCorreo">
					  ...
					  <div class="da-form-row">
						   <label style="text-align:right;"><b>Nombre</b></label>
						   <div class="da-form-item large">
					   ...
					   <div class="da-form-row">
						   <label style="text-align:right;"><b>Correo</b></label>
						   <div class="da-form-item large">
						    <input class="textbox required" type="text" id="txtCorreo" value="" autocomplete="off"/>
						    <span class="errorMessage" id="errorcorreo"></span>
						   </div>
					  </div>
	...
	echo'<div class="da-panel">
	 ...
	 echo'<div class="da-panel">
			  <div class="da-panel-header">
				  <span class="da-panel-title">
					  <img src="images/icons/black/16/pencil.png" alt="" />
					  Añadir nueva agencia
				  </span>
			  </div>
			  <div class="da-panel-content">
				  <form class="da-form" action="" method="POST" name="formCreaAgencia" id="formCreaAgencia">
					  <div class="da-form-row">
						   <label style="text-align:right; width:135px; padding-right:5px;"><b>Entidad Financiera</b></label>
					  ...
					  <div class="da-form-row">
						   <label style="width:140px;"><b>Departamento/Sucursal</b></label>
						   <div class="da-form-item">
							   <select id="id_depto" class="requerid">';
								  ...
								  $res->free();
						  echo'</select>
							   <span class="errorMessage" id="errorregion"></span>
						   </div>
					  </div>
					  <div class="da-form-row">
						   <label style="text-align:right; width:135px; padding-right:5px;"><b>Agencia</b></label>
						   <div class="da-form-item">
						     <input class="textbox required" type="text" id="txtAgencia" value="" autocomplete="off"/>
						     <span class="errorMessage" id="erroragencia"></span>
						   </div>
					  </div>
					   <div class="da-form-row">
						   <label style="text-align:right; width:135px; padding-right:5px;"><b>Codigo</b></label>
						   <div class="da-form-item">
					  ...
					  <div class="da-form-row" style="display:none" id="content-emision">
						  <label style="text-align:right; width:135px; padding-right:5px;"><b>Emitir</b></label>
						  <div class="da-form-item">
							  <ul class="da-form-list inline">
								  <li><input type="radio" name="emitir" id="rd-1" value="1" class="required"/> <label>Si</label></li>
	...
	$num_reg = $res1->num_rows;
	 echo'<div class="da-panel">
			  <div class="da-panel-header">
				  <span class="da-panel-title">
					  <img src="images/icons/black/16/pencil.png" alt="" />
					  Añadir Nuevo Departamento/Sucursal
				  </span>
			  </div>
			  <div class="da-panel-content">
				  <form class="da-form" action="" method="POST" name="formCreaSucursal" id="formCreaSucursal">
					  <div class="da-form-row">
						   <label style="text-align:right;"><b>Departamento/Sucursal</b></label>
						   <div class="da-form-item large" style="text-align:right;">
						     ...
						     <span class="errorMessage" id="errorsucursal"></span>
						   </div>
					  </div>
					  <div class="da-form-row">
					  ...
					  <div class="da-form-row">
						   <label style="text-align:right; margin-right:300px;"><b>Tipo</b></label><br/>
						   <div style="text-align:center; padding-left:15px; padding-right:15px;">
							  ...
							  echo'</td>';
								   ...
								   echo'<td style="width:33%; text-align:center;">
										   <input type="checkbox" name="tiporeg" id="tiporeg" value="regional" class="required"/>Regional
									    </td>';
									}else{
							  ...
							  echo'<td style="widht:34%; text-align:center;">';
								     if(base64_decode($_GET['tipo_sesion'])!='ADM'){
							          echo'<input type="checkbox" name="tipodepto" id="tipodepto" value="depto" class="required"/>Departamento';
									 }else{
										echo'&nbsp;';
								     }
							  echo'</td>
								...
								<tr>
								 <td colspan="3"><span class="errorMessage" id="errortipo"></span></td>
								</tr>
							  </table>
					       </div>
					  </div>
	...
	echo'<div class="da-panel">
					  ...
					  <div class="da-form-row">
						   ...
						   <div style="text-align:center; padding-left:15px; padding-right:15px;">
							  ...
							  echo'</td>
							       <td style="width:33%; text-align:center;">';
							         if($regi['tipo_re']==1){
							            echo'<input type="checkbox" name="tiporeg" class="tiporeg" checked disabled/>Regional';
									 }else{
								        echo'<input type="checkbox" name="tiporeg" class="tiporeg" disabled/>Regional';
									 }

							  echo'</td>
							       <td style="widht:34%; text-align:center;">';
							         if($regi['tipo_dp']==1){
							           echo'<input type="checkbox" name="tipodepto" class="tipodepto" checked disabled/>Departamento';
									 }else{
									   echo'<input type="checkbox" name="tipodepto" class="tipodepto" disabled/>Departamento';
									 }
							echo'  </td>
							    </tr>
							  </table>
	 ...
	 echo'<div class="da-panel">
			  <div class="da-panel-header">
				  <span class="da-panel-title">
					  <img src="images/icons/black/16/pencil.png" alt="" />
					  Añadir Cia. de Seguros a Entidad Financiera
				  </span>
			  </div>
			  <div class="da-panel-content">
				  <form class="da-form" action="" method="POST" name="formCreaAdCia" id="formCreaAdCia">
					  ...
					  <div class="da-form-row">
						   <label style="text-align:right;"><b>Compañia de Seguros</b></label>
						   <div class="da-form-item large">
							   <select id="idcompania" class="requerid">';
								  echo'<option value="">seleccione...</option>';
								  while($regi2 = $res2->fetch_array(MYSQLI_ASSOC)){
	...
	echo'<div class="da-panel">
			...
			<div class="da-panel-content">
				<form class="da-form" name="frmAdTipVehi" id="frmAdTipVehi" action="" method="post">
					...
					<div class="da-form-row">
						<label style="text-align:right;"><b>Tipo de Vehiculo</b></label>
						<div class="da-form-item large">
							<input type="text" id="txtTipVehi" value="" class="required"/>
							<span class="errorMessage" id="errortipvehi"></span>
						</div>
					</div>
					<div class="da-button-row">';
					  if($num_reg>0){
	...
	echo'<div class="da-panel">
			...
			<div class="da-panel-content">
				<form class="da-form" name="frmAdMarca" id="frmAdMarca" action="" method="post">
					...
					<div class="da-form-row">
						<label style="text-align:right;"><b>Marca de Auto</b></label>
						<div class="da-form-item large">
							<input type="text" id="txtMarcaAuto" value="" class="required"/>
							<span class="errorMessage" id="errormarcauto"></span>
						</div>
					</div>
					<div class="da-button-row">';
					  if($num_reg>0){
	...
	echo'<div class="da-panel">
			...
			<div class="da-panel-content">
				<form class="da-form" name="frmAdModelo" id="frmAdModelo" action="" method="post">
					...
					<div class="da-form-row">
						 <label style="text-align:right;"><b>Marca</b></label>
						 <div class="da-form-item large">
							 '.base64_decode($_GET['marca']).'
						 </div>
					</div>
					<div class="da-form-row">
						<label style="text-align:right;"><b>Modelo de Auto</b></label>
						<div class="da-form-item large">
							<input type="text" id="txtModeloAuto" value="" class="required"/>
							<span class="errorMessage" id="errormodeauto"></span>
						</div>
					</div>
					<div class="da-button-row">
					   <input type="submit" value="Guardar" class="da-button green"/>
...
$num_regi_ef = $resef->num_rows;
	echo'<div class="da-panel">
			  ...
			  <div class="da-panel-content">
				  <form class="da-form" action="" method="POST" name="formAdTip" id="formAdTip">
					  <div class="da-form-row">
						   <label style="width:120px; text-align:right;"><b>Entidad Financiera:</b></label>
						   <div class="da-form-item large">
							   <select id="idefin" class="requerid">';
								  echo'<option value="">seleccione...</option>';
					  ...
					  <div class="da-form-row">
						   <label style="width:120px; text-align:right;"><b>Tipo de registro:</b></label>
						   <div class="da-form-item large">
							   ...
							   <span class="errorMessage" id="errortipproducto"></span>
						   </div>
					  </div>
					  <div class="da-button-row">
					      <input type="submit" value="Guardar" class="da-button green"/>
			...
			<div class="da-panel-content">
				<form class="da-form" name="frmAdProductos" id="frmAdProductos" action="" method="post">
					...
					<div class="da-form-row">
						<label style="text-align:right;"><b>Producto</b></label>
						<div class="da-form-item large">
							<input type="text" id="txtProductos" value="" class="required"/>
							<span class="errorMessage" id="errorproductos"></span>
						</div>
					</div>
					<div class="da-button-row">
					   <input type="submit" value="Guardar" class="da-button green"/>
    ...
    echo'<div class="da-panel">
			...
			<div class="da-panel-content">
				<form class="da-form" name="frmAdPregunta" id="frmAdPregunta" action="" method="post">
					...
					<div class="da-form-row" id="content-entidadf" style="display:none;">
						<label text-align:right; margin-right:10px;><b>Producto</b></label>
						<div class="da-form-item small">
						  <span id="entidad-loading" class="loading-entf">';
							   $select="select
										  id_home,
										  ...
										  end as producto_text,
										  id_ef
										from
										  s_sgc_home
										where
										  id_ef='".base64_decode($_GET['id_ef'])."' and producto!='H';";
								$sql = $conexion->query($select,MYSQLI_STORE_RESULT);
								echo'<select name="producto" id="producto" class="required" style="width:170px;">';
											echo'<option value="">Seleccionar...</option>';
											while($regief = $sql->fetch_array(MYSQLI_ASSOC)){
											  echo'<option value="'.$regief['producto'].'">'.$regief['producto_text'].'</option>';
											}
											$sql->free();
								echo'</select>
									 <span class="errorMessage" id="errorproducto"></span>';
					...
					<div class="da-form-row">
						<label style="text-align:right;"><b>Respuesta esperada</b></label>
						<div class="da-form-item large">';
						echo'<select name="txtRespuesta" id="txtRespuesta" style="width:120px;" class="required">
						        <option value="">Seleccione...</option>
								<option value="1">Si</option>
								<option value="0">No</option>
						     </select>
							 <span class="errorMessage" id="errorespuesta"></span>';
						/*
	...
	$selectFor="select
				...
				from
				  s_pregunta
				where
				  id_ef_cia='".base64_decode($_GET['id_ef_cia'])."' and id_pregunta=".base64_decode($_GET['idpregunta'])." and producto='DE';";
	...
	echo'<div class="da-panel">
			...
			<div class="da-panel-content">
				<form class="da-form" name="frmEdiPregunta" id="frmEdiPregunta" action="" method="post">
					<div class="da-form-row">
						<label style="text-align:right; text-align:right;"><b>Entidad Financiera</b></label>
						<div class="da-form-item small">
							'.base64_decode($_GET['entidad']).'
							<input type="hidden" name="idcompania" id="idcompania" value=""/>
						</div>
	...
	$select="select
			...
			from
			  s_tipo_cambio
			where
			  id_ef='".base64_decode($_GET['id_ef'])."' and activado=1;";
	$sql = $conexion->query($select, MYSQLI_STORE_RESULT);
			...
			<div class="da-panel-content">
				<form class="da-form" name="frmAdProdExtra" id="frmAdProdExtra" action="" method="post">
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%" align="left">
						   <tr>
						     <td style="width:25%; text-align:center;">
							    <lable><b>Rango Minimo (Bs)</b></lable>
							 ...
							 <td style="width:25%; text-align:center;">
							    <lable><b>Rango Maximo (Bs)</b></lable>
								<div class="da-form-item large" style="margin-left:0;">
							 ...
							 <td style="width:25%; text-align:center;">
							    <lable><b>Rango Minimo (Usd)</b></lable>
								<div class="da-form-item large" style="margin-left:0;">
							 ...
							 <td style="width:25%; text-align:center;">
							    <lable><b>Rango Maximo (Usd)</b></lable>
								<div class="da-form-item large" style="margin-left:0;">
						   ...
						   <tr>
						      <td style="text-align:center;">
							    <lable><b>Hospitalario (Usd)</b></lable>
								<div class="da-form-item large" style="margin-left:0;">
					...
					<div class="da-button-row">
						...
						<input type="hidden" id="id_ef_cia" name="id_ef_cia" value="'.base64_decode($_GET['id_ef_cia']).'"/>
						<input type="hidden" id="valor_boliviano" value="'.$reg['valor_boliviano'].'"/>
						<div id="response-loading" class="loading-fac"></div>
					</div>
				</form>
			</div>
	...
	$select="select
			...
			from
			 ...
			 inner join s_tipo_cambio as stc on (stc.id_ef=efcia.id_ef)
			where
			...
			<div class="da-panel-content">
				<form class="da-form" name="frmEdiProdExtra" id="frmEdiProdExtra" action="" method="post">
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%" align="left">
						   <tr>
						     <td style="width:25%; text-align:center;">
							    <lable><b>Rango Minimo (Bs)</b></lable>
								<div class="da-form-item large" style="margin-left:0;">
									<input class="textbox required" type="text" name="txtRgMinBs" id="txtRgMinBs" value="'.$phpArray[1].'" style="width:125px;"/>
									<span class="errorMessage" id="errorminbs"></span>
								</div>
							 </td>
							 <td style="width:25%; text-align:center;">
							    <lable><b>Rango Maximo (Bs)</b></lable>
								<div class="da-form-item large" style="margin-left:0;">
									<input class="textbox required" type="text" name="txtRgMaxBs" id="txtRgMaxBs" value="'.$phpArray[2].'" style="width:125px;"/>
									<span class="errorMessage" id="errormaxbs"></span>
								</div>
							 </td>
							 <td style="width:25%; text-align:center;">
							    <lable><b>Rango Minimo (Usd)</b></lable>
								<div class="da-form-item large" style="margin-left:0;">
								  <input class="textbox required" type="text" name="txtRgMinUsd" id="txtRgMinUsd" value=" '.$phpArray[3].'" style="width:125px;" readonly="readonly"/>
								  <span class="errorMessage" id="errorminusd"></span>
								</div>
						     </td>
							 <td style="width:25%; text-align:center;">
							    <lable><b>Rango Maximo (Usd)</b></lable>
								<div class="da-form-item large" style="margin-left:0;">
								  <input class="textbox required" type="text" name="txtRgMaxUsd" id="txtRgMaxUsd" value="'.$phpArray[4].'" style="width:125px;" readonly="readonly"/>
								  <span class="errorMessage" id="errormaxusd"></span>
								</div>
							 </td>
						   </tr>
					...
					<div class="da-button-row">
						<input type="submit" value="Guardar" class="da-button green" name="btnSave" id="btnSave"/>
						<input type="hidden" id="id_ef_cia" name="id_ef_cia" value="'.base64_decode($_GET['id_ef_cia']).'"/>
						<input type="hidden" id="id_pr_extra" name="id_pr_extra" value="'.base64_decode($_GET['id_pr_extra']).'"/>
						<input type="hidden" id="valor_boliviano" value="'.$regi['valor_boliviano'].'"/>
						<div id="response-loading" class="loading-fac"></div>
					</div>
				</form>
			</div>
	   ...
	   echo'<div class="da-panel">
			...
			<div class="da-panel-content">
				<form class="da-form" name="frmAdMarcaTarjeta" id="frmAdMarcaTarjeta" action="" method="post">
					...
					<div class="da-form-row">
						<label style="text-align:right;"><b>Marca de la Tarjeta:</b></label>
						<div class="da-form-item large">
					  ...
					  echo'</select>
							<span class="errorMessage" id="errormarcatarjeta"></span>
						</div>
					</div>
					<div class="da-button-row">
					   <input type="submit" value="Guardar" class="da-button green"/>
	   ...
	   echo'<div class="da-panel">
			...
			<div class="da-panel-content">
				<form class="da-form" name="frmAdTipoTarjeta" id="frmAdTipoTarjeta" action="" method="post">
					<div class="da-form-row">
						<label style="text-align:right;"><b>Tipo de Tarjeta:</b></label>
						<div class="da-form-item large">
					  ...
					  echo'</select>
							<span class="errorMessage" id="errortipotarjeta"></span>
						</div>
					</div>
					<div class="da-button-row">
					   <input type="submit" value="Guardar" class="da-button green"/>
