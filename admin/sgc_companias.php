								   ...
								   echo'</td>
										<td class="da-icon-column">
										   <ul class="action_user">
											  ...
											  if($regi['activado']=='deshabilitado'){
												  echo'<li><a href="#" id="'.base64_encode($regi['id_compania']).'|activar" class="daralta da-tooltip-s accionef" title="Activar"></a></li>';
											  }else{
												  echo'<li><a href="#" id="'.base64_encode($regi['id_compania']).'|desactivar" class="darbaja da-tooltip-s accionef" title="Desactivar"></a></li>';  
											  }
											  /*
											  if($regi['activado']=='deshabilitado'){
