                	...
                	<div id="da-content-area">
                    	...
                    	<div class="grid_4">
							...
							if(isset($_GET['crear_contenido'])) {
								...
								agregar_nuevo_contenido_todoriesgodomi($id_usuario_sesion, $tipo_sesion, $usuario_sesion, $id_ef_sesion, $conexion);
								...
								if(isset($_GET['idhome'])) {
									...
									if(isset($_GET['editar'])) {
										...
										editar_contenido_todoriesgodomi($id_usuario_sesion, $tipo_sesion, $usuario_sesion, $id_ef_sesion, $conexion);
									} 
									...
									mostrar_lista_contenido_todorieagodomi($id_usuario_sesion, $tipo_sesion, $usuario_sesion, $id_ef_sesion, $conexion);
								}
							}
...
function mostrar_lista_contenido_todorieagodomi($id_usuario_sesion, $tipo_sesion, $usuario_sesion, $id_ef_sesion, $conexion){
?>
...
<script type="text/javascript">
  ...
  $(function(){
    ...
    <?php if($msg!=''){ ?>
		 ...
		 setTimeout( "$(location).attr('href', 'index.php?l=tr_contenido&var=<?php echo $var;?>');",5000 );
	<?php }?>
						...
						<div class="da-panel-header" style="text-align:right; padding-top:5px; padding-bottom:5px;">
							<ul class="action_user">
								<li style="margin-right:6px;">
								   <a href="?l=tr_contenido&crear_contenido=v&var='.$_GET['var'].'" class="da-tooltip-s various fancybox.ajax" title="Añadir nuevo registro">
			  ...
			  while($regief = $resef->fetch_array(MYSQLI_ASSOC)){
				  $selectCont="select
							  ...
							  from
								s_sgc_home
							  where
								id_ef='".$regief['id_ef']."' and producto='TRD';";
						  ...
						  <div class="da-panel collapsible">
							  <div class="da-panel-header">
								  <span class="da-panel-title">
									  ...
									  <b>'.$regief['nombre'].'</b> - Contenido Automotores
								  </span>
							  </div>
												  ...
												  echo'<tr>
													 ...
													 echo'</td>
														  ...
														  <td class="da-icon-column">
															 <ul class="action_user">
																<li style="margin-right:5px;"><a href="?l=tr_contenido&editar=v&var='.$_GET['var'].'&idhome='.base64_encode($regi['id_home']).'&id_ef='.base64_encode($regief['id_ef']).'" class="edit da-tooltip-s" title="Editar"></a></li>';
														echo'</ul>	
														  </td>
													  </tr>';
											  }
...
function editar_contenido_todoriesgodomi($id_usuario_sesion, $tipo_sesion, $usuario_sesion, $id_ef_sesion, $conexion){
	...
	if(isset($_POST['accionGuardar'])) {
		...
		if($errFlag) {
			...
			mostrar_editar_contenido_todoriesgodomi($id_usuario_sesion, $tipo_sesion, $usuario_sesion, $id_ef_sesion, $conexion, $errArr);
		} else {
			   //SEGURIDAD
			   ...
			   $update.="html='".$content_txt."' WHERE id_home = '".$idhome."' and id_ef ='".$id_ef."' and producto='TRD' LIMIT 1;";
			...
			if($conexion->query($update)===TRUE){
			   ...
			   header('Location: index.php?l=tr_contenido&var='.$_GET['var'].'&op=1&msg='.$mensaje);
			   exit;
			} else{
			   $mensaje="Hubo un error al ingresar los datos, consulte con su administrador ".$conexion->errno.": ". $conexion->error;
			   header('Location: index.php?l=tr_contenido&var='.$_GET['var'].'&op=2&msg='.$mensaje);
			   exit;
			}  
...
function mostrar_editar_contenido_todoriesgodomi($id_usuario_sesion, $tipo_sesion, $usuario_sesion, $id_ef_sesion, $conexion, $errArr){
?>
...
<?php
  ...
  $selectImg="select
				...
				where
				  sh.id_home='".$idhome."' and sh.id_ef='".$id_ef."' and sh.producto='TRD' and sef.activado=1;";
  //echo $selectImg;
		  ...
		  <div class="da-panel">
			  <div class="da-panel-header">
				  <span class="da-panel-title">
					  ...
					  Actualizar Contenido Todo Riesgo Domiciliario
				  </span>
			  </div>
			  <div class="da-panel-content">
...
function agregar_nuevo_contenido_todoriesgodomi($id_usuario_sesion, $tipo_sesion, $usuario_sesion, $id_ef_sesion, $conexion){
	...
	if(isset($_POST['accionGuardar'])) {
		...
		if($errFlag) {
			//HUBIERON ERRORES, MOSTRAMOS EL FORM CON LOS ERRORES
			mostrar_agregar_contenido_todoriesgodomi($id_usuario_sesion, $tipo_sesion, $usuario_sesion, $id_ef_sesion, $conexion, $errArr);
		} else {
			   //SEGURIDAD
			   $especiales = array("\r\n", "\n", "\r", "\t");
			   $reemplazos = array("", "", "", "");
			   ...
			   $insert ="INSERT INTO s_sgc_home(id_home, id_ef, producto, html, imagen, id_usuario) "
					   ."VALUES('".$id_new_home."', '".$id_ef."', 'TRD', '".$contenido."' ,'".$imagenServidor."', '".$id_usuario_sesion."')";
...
function mostrar_agregar_contenido_todoriesgodomi($id_usuario_sesion, $tipo_sesion, $usuario_sesion, $id_ef_sesion, $conexion, $errArr){
?>
