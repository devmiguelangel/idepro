										...
										echo'<tr>
										   ...
										   echo'</td>
												...
												<td class="da-icon-column">
												   <ul class="action_user">
													  <li style="margin-right:5px;"><a href="?l=trem_contenido&editar=v&var='.$_GET['var'].'&idhome='.base64_encode($regi['id_home']).'&id_ef='.base64_encode($regief['id_ef']).'" class="edit da-tooltip-s" title="Editar"></a></li>';
											  echo'</ul>	
												</td>
											</tr>';
									}
 ...
 echo'
	<div class="da-panel collapsible">
		<div class="da-panel-header" style="text-align:right; padding-top:5px; padding-bottom:5px;">
			<ul class="action_user">
				<li style="margin-right:6px;">
				   <a href="?l=trem_contenido&var='.$_GET['var'].'" class="da-tooltip-s" title="Volver">
