	...
	if($num_ref_ef>0){
	   echo'<div class="da-panel collapsible">
				<div class="da-panel-header" style="text-align:right; padding-top:5px; padding-bottom:5px;">
					<ul class="action_user">
						<li style="margin-right:6px;">
						   <a href="adicionar_registro.php?opcion=crear_adciaef" class="da-tooltip-s various fancybox.ajax" title="Añadir Cia. a Entindad">
											   ...
											   echo'</td>
												    ...
												    <td class="da-icon-column">
													   <ul class="action_user">';
														  ...
														  if($regicia['activado']=='inactivo'){
															  echo'<li><a href="#" id="'.base64_encode($regicia['id_ef_cia']).'|activar" class="daralta da-tooltip-s accion_active" title="Activar"></a></li>';
														  }else{
															  echo'<li><a href="#" id="'.base64_encode($regicia['id_ef_cia']).'|desactivar" class="darbaja da-tooltip-s accion_active" title="Desactivar"></a></li>';  
														  }
												  echo'</ul>	
												    </td>
											  </tr>';
		...
		echo'<div class="da-message error">
				   La(s) entidad(es) financiera(s) no esta activada(s) 
			  </div>';
	}
}
