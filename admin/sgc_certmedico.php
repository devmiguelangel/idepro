						...
						<div class="da-panel collapsible" style="width:900px;">
							<div class="da-panel-header">
								<span class="da-panel-title">
									...
									<b>'.$regief['nombre'].'</b> - Editar Certificado M&eacute;dico</b>
								</span>
							</div>
												   ...
												   echo'</td>
														...
														<td class="da-icon-column">
														   <ul class="action_user">
															  <li style="margin-right:5px;"><a href="?l=certmedico&id_ef_cia='.base64_encode($regi['id_ef_cia']).'&id_ef='.base64_encode($regief['id_ef']).'&entidad='.base64_encode($regief['nombre']).'&compania='.base64_encode($regi['compania']).'&listar_cert_medicos=v&var='.$_GET['var'].'" class="cert-medico da-tooltip-s" title="Certificados Medicos"></a></li>';
   ...
   if($res = $conexion->query($selectFor,MYSQLI_STORE_RESULT)){
			...
			<div class="da-panel-header" style="text-align:right; padding-top:5px; padding-bottom:5px;">
				<ul class="action_user">
					<li style="margin-right:6px;">
					   <a href="?l=certmedico&var='.$_GET['var'].'" class="da-tooltip-s" title="Volver">
					   <img src="images/retornar.png" width="32" height="32"></a>
					</li>
					<li style="margin-right:6px;">
					   <a href="certmedico_registro.php?opcion=crear_cert&id_ef_cia='.$_GET['id_ef_cia'].'&entidad='.$_GET['entidad'].'&compania='.$_GET['compania'].'" class="da-tooltip-s various fancybox.ajax" title="Crear Certificado">
					   <img src="images/add_cert.png" width="32" height="32"></a>
					</li>
					<li style="margin-right:6px;">
					   <a href="?l=certmedico&listarcuestionario=v&var='.$_GET['var'].'&id_ef_cia='.$_GET['id_ef_cia'].'&entidad='.$_GET['entidad'].'&compania='.$_GET['compania'].'" class="da-tooltip-s" title="Crear Cuestionario">
					   <img src="images/add_cuestionario.png" width="32" height="32"></a>
					</li>
					<li>
					   <a href="?l=certmedico&listarpregunta=v&var='.$_GET['var'].'&id_ef_cia='.$_GET['id_ef_cia'].'&entidad='.$_GET['entidad'].'&compania='.$_GET['compania'].'" class="da-tooltip-s" title="Crear Preguntas">
		...
		<div class="da-panel collapsible">
			<div class="da-panel-header">
				<span class="da-panel-title">
					<img src="images/icons/black/16/list.png" alt="" />
					<b>'.$entidad.'</b> - Listado Certificados Medicos
				</span>
			</div>
			<div class="da-panel-content">
				<table class="da-table">
					<thead>
						<tr>
							<th><b>Tipo Certificado</b></th>
							<th><b>Titulo</b></th>
							<th><b>Compañía de Seguros</b></th>
							<th style="text-align:center;"><b>Activo</b></th>
							<th></th>
						</tr>
					</thead>
					<tbody>';
										...
										<td class="da-icon-column">
										   <ul class="action_user">';
												if($regi['activado']!=1){
													...
													echo'<li style="margin-right:5px;"><a href="certmedico_registro.php?opcion=editar_cert&idcm='.base64_encode($regi['id_cm']).'&id_ef_cia='.$_GET['id_ef_cia'].'&entidad='.$_GET['entidad'].'&compania='.$_GET['compania'].'" class="edit da-tooltip-s various fancybox.ajax" title="Editar"></a></li>';
												}else{
												//echo'<li style="margin-right:5px;"><a href="#" class="editar_disabled"></a></li>';
													...
													echo'<li><a href="?l=certmedico&idcm='.base64_encode($regi['id_cm']).'&agregarqu=v&var='.$_GET['var'].'&tipocert='.base64_encode($regi['tipo']).'&compania='.$_GET['compania'].'&entidad='.$_GET['entidad'].'&id_ef_cia='.$_GET['id_ef_cia'].'" class="add-cuestionario da-tooltip-s" title="Agregar Cuestionario"></a></li>';
													  //}
													}
												}
...
<div class="da-panel collapsible">
    <div class="da-panel-header" style="text-align:right; padding-top:5px; padding-bottom:5px;">
		<ul class="action_user">
			<li style="margin-right:6px;">
			   <a href="?l=certmedico&var='.$_GET['var'].'&listar_cert_medicos=v&id_ef_cia='.$_GET['id_ef_cia'].'&entidad='.$_GET['entidad'].'&compania='.$_GET['compania'].'" class="da-tooltip-s" title="Volver">
			   <img src="images/retornar.png" width="32" height="32"></a>
			</li>
			<li style="margin-right:6px;">
			   <a href="certmedico_registro.php?opcion=crear_question" class="da-tooltip-s cuestionario fancybox.ajax" title="Crear Cuestionario">
			   <img src="images/add_cert.png" width="32" height="32"></a>
			</li>
		</ul>
	</div>
						...
						echo'<tr>
								...
								<td class="da-icon-column">
								   <ul class="action_user">';
									    ...
									    echo'<li style="margin-right:5px;"><a href="certmedico_registro.php?opcion=editar_question&idcuestionario='.$regi['id_cuestionario'].'" class="edit da-tooltip-s cuestionario fancybox.ajax" title="Editar"></a>
										     </li>';
										echo'<li><a href="#" class="eliminar da-tooltip-s" title="Eliminar" id="'.$regi['id_cuestionario'].'"></a></li>';
							  echo'</ul>	
								</td>
							</tr>';
					}
...
<div class="da-panel collapsible">
    <div class="da-panel-header" style="text-align:right; padding-top:5px; padding-bottom:5px;">
		<ul class="action_user">
			...
			<li style="margin-right:6px;">
			   <a href="certmedico_registro.php?opcion=crear_pregunta" class="da-tooltip-s pregunta fancybox.ajax" title="Crear Pregunta">
			   <img src="images/add_cert.png" width="32" height="32"></a>
			</li>
		</ul>
	</div>
	...
	<div class="da-panel-content">
		<table class="da-table">
			<thead>
				<tr>
					<th><b>Pregunta</b></th>
					<th style="width:150px;"><b>Tipo</b></th>
					<th></th>
				</tr>
			</thead>
			<tbody>';
						...
						echo'<tr>
								...
								<td class="da-icon-column">
								   <ul class="action_user">';
									    ...
									    echo'<li style="margin-right:5px;"><a href="certmedico_registro.php?opcion=editar_pregunta&idpregunta='.$regi['id_pregunta'].'" class="edit da-tooltip-s pregunta fancybox.ajax" title="Editar"></a>
										     </li>';
										echo'<li><a href="#" class="eliminar da-tooltip-s" title="Eliminar" id="'.$regi['id_pregunta'].'"></a></li>';
							  echo'</ul>	
								</td>
							</tr>';
					}
   ...
   if($res = $conexion->query($select,MYSQLI_STORE_RESULT)){
		...
		<div class="da-panel collapsible">
			<div class="da-panel-header" style="text-align:right; padding-top:5px; padding-bottom:5px;">
				<ul class="action_user">
					...
					<li style="margin-right:6px;">
					   <a href="certmedico_registro.php?opcion=adicionar_cuestionario_cert&tipocert='.$_GET['tipocert'].'&compania='.$_GET['compania'].'&entidad='.$_GET['entidad'].'&idcm='.$_GET['idcm'].'" class="da-tooltip-s pregunta fancybox.ajax" title="Adicionar cuestionario">
		...
		<div class="da-panel collapsible">
			<div class="da-panel-header">
				<span class="da-panel-title">
					<img src="images/icons/black/16/list.png" alt="" />
					<b>'.$entidad.'</b> - Listado de cuestionarios agregados
				</span>
			</div>
			<div class="da-panel-content">
				<table class="da-table">
   ...
   if($res = $conexion->query($select,MYSQLI_STORE_RESULT)){
		...
		<div class="da-panel collapsible">
			<div class="da-panel-header" style="text-align:right; padding-top:5px; padding-bottom:5px;">
				<ul class="action_user">
					<li style="margin-right:6px;">
					   <a href="?l=certmedico&var='.$_GET['var'].'&agregarqu=v&idcm='.$_GET['idcm'].'&compania='.$_GET['compania'].'&entidad='.$_GET['entidad'].'&id_ef_cia='.$_GET['id_ef_cia'].'&tipocert='.$_GET['tipocert'].'" class="da-tooltip-s" title="Volver">
					   <img src="images/retornar.png" width="32" height="32"></a>
					</li>
					<li style="margin-right:6px;">
					   <a href="certmedico_registro.php?opcion=adicionar_pregunta_cuest&cuestionario='.$_GET['cuestionario'].'&compania='.$_GET['compania'].'&entidad='.$_GET['entidad'].'&id_ef_cia='.$_GET['id_ef_cia'].'&id_cc='.$_GET['idcc'].'&id_cm='.$_GET['idcm'].'" class="da-tooltip-s pregunta fancybox.ajax" title="Adicionar pregunta">
					   <img src="images/add_cert.png" width="32" height="32"></a>
					</li>
				</ul>
			</div>
		...
		<div class="da-panel collapsible" style="width:850px;">
			<div class="da-panel-header">
				<span class="da-panel-title">
					...
					<div style="margin-left:24px;">'.base64_decode($_GET['cuestionario']).' - Listado de preguntas agregadas</div>
				</span>
			</div>
			<div class="da-panel-content">
				<table class="da-table">
