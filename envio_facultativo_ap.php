...
WHERE t0.facultativo = 1 and t0.emitir = 1 and t6.aprobado='SI' and t0.anulado = 0
...
$shtml="<table border='0' cellspacing='1' cellpadding='0' style='width:150%; font-size:9pt;'>";
			$shtml.='<tr><td colspan="17" align="center"> CASOS FACULTATIVOS  APROBADOS POR LA ASEGURADORA FECHA &nbsp;'.$date1.'</td></tr>';
...
$sfile=$scarpeta."/Facultativo Aprobados y Emitidos_".$date1.".xls"; //ruta del archivo a generar
$fp=fopen($sfile,"w");
